...
storiesOf('Rich text', module)
  ...
  .add('Separate elements', () => ({
      ...
      data() {
        return {
          dynamicText: text('First paragraph', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum. Libero enim sed faucibus turpis. Lobortis elementum nibh tellus molestie nunc non. Elementum integer enim neque volutpat ac tincidunt vitae semper quis.') + '</p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum. Libero enim sed faucibus turpis. Lobortis elementum nibh tellus molestie nunc non. Elementum integer enim neque volutpat ac tincidunt vitae semper quis.',
          textVariations: [
            {
              type: '<strong>',
              shortText: '<p>Lorem ipsum <strong>dolor sit amet</strong>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum.</p>'
            },
            {
              type: '<em>',
              shortText: '<p>Lorem ipsum <em>dolor sit amet</em>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum.</p>'
            },
            {
              type: '<small>',
              shortText: '<p>Lorem ipsum <small>dolor sit amet</small>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum.</p>'
            },
            {
              type: '<a>',
              shortText: '<p>Lorem ipsum <a href="#">dolor sit amet</a>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra. Magna etiam tempor orci eu lobortis elementum.</p>'
            },
            {
              type: '<blockquote>',
              shortText: '<blockquote><p>Everything in this world is magic, except for the magician.</p></blockquote>'
            },
            {
              type: '<table>',
              shortText: `<table style="border-collapse: collapse; width: 100%;" border="1">
                            <tbody>
