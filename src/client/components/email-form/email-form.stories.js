  ...
  .add('Default', () => ({
    ...
    data: () => ({
      "form": {
        ...
        "labelEmail": "We just need your email address",
        "body": "<p>The Lean Web Kit is still in its early stages. If you're a dare devil, you can already get access now.</p>",
